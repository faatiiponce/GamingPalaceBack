const { User, Productinchart, Cart, Historiccart, Historicproduct} = require("../db");
...
themonth++
  //end test
for (let i = 0; i < productsinchart.length; i++){ //ITERA LOS PRODUCT IN CHART
        for (let a = 0; a < productsinchart[i].dataValues.quantity; a++) { //ITERAR UNA VEZ POR CADA QUANTITY
